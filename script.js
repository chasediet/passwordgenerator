        ...
        function getPasswordCriteria() {
            passwordLength = parseInt(prompt("How many characters would you like your password to contain? (Choose a number between 8 and 128)"));
        ...
        function generatePassword() {
            ...
            if (includeNumeric) {
                ...
                generatedPassword += numericChars.charAt(Math.floor(Math.random() * numericChars.length));
            }
            if (includeSpecial) {
